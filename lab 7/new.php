       ...
       function checkName() {
        ...
        function checkDOB() {
			...
			if (document.getElementById("dob").value == "") {
			  	document.getElementById("dobErr").innerHTML = "Must be valid numbers(dd:1-31,mm: 1-12,yyyy: 1950-2000)";
...
<b>Mother Name:</b> <input type="text" name="mname" id="mname" onkeyup="checkMName()" onblur="checkMName()">  <span id="mnameErr"></span>
     ...
     <b>Gender:</b> <input type="radio" name="gender" id="male" onkeyup="checkGENDER()" onblur="checkGENDER()">Male
            <input type="radio" name="gender" id="female" onkeyup="checkGENDER()" onblur="checkGENDER()">Female
            <input type="radio" name="gender" id="Others" onkeyup="checkGENDER()" onblur="checkGENDER()">Others  
